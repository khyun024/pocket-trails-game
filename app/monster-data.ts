...
export const MONSTERS: Monster[] = [
  { id: "leaflet", name: "이상해씨", sprite: "/monsters/이상해씨.png", type: "풀/독", color: "#54c96b", rarity: 1, description: "며칠 동안 아무것도 먹지 않아도 건강하다! 등에 있는 씨앗에는 많은 영양분이 있어서 문제없다!" },
  { id: "emberoo", name: "파이리", sprite: "/monsters/파이리.png", type: "불꽃", color: "#ff7657", rarity: 2, description: "조용한 곳에 데려가면 꼬리가 타고 있는 작은 소리가 들린다." },
  { id: "bubbloo", name: "꼬부기", sprite: "/monsters/꼬부기.png", type: "물", color: "#5ebcf6", rarity: 1, description: "수면에서 물을 분사하여 먹이를 잡는다. 위험해지면 등껍질에 손발을 감추고 몸을 지킨다." },
  ...
  { id: "monster-009", name: "이상해풀", sprite: "/monsters/이상해풀.png", type: "풀/독", color: "#6fbd67", rarity: 5, description: "양분을 흡수해서 커진 봉오리에서 향기가 나기 시작하면 곧 꽃이 핀다는 증거다." },
  ...
  { id: "monster-020", name: "뮤츠", sprite: "/monsters/뮤츠.png", type: "에스퍼", color: "#8799a1", rarity: 5, catchRate: 0.01, description: "뮤와 유전자가 완전 같다. 하지만 크기도 성격도 무서울 정도로 다르다." },
  { id: "monster-021", name: "이브이", sprite: "/monsters/이브이.png", type: "노말", color: "#b98a5f", rarity: 2, description: "주위 환경에 맞춰 몸의 구조를 바꾸는 능력을 지닌 포켓몬이다." },
  { id: "monster-022", name: "잠만보", sprite: "/monsters/잠만보.png", type: "노말", color: "#5e8c87", rarity: 4, catchRate: 0.18, description: "먹고 자는 일을 반복하다가 하루에 많은 양을 먹으면 깊이 잠든다." },
  { id: "monster-023", name: "라프라스", sprite: "/monsters/라프라스.png", type: "물/얼음", color: "#63a9d5", rarity: 4, catchRate: 0.16, description: "사람의 말을 이해하며 바다 위를 등에 태우고 건너는 온순한 포켓몬이다." },
  { id: "monster-024", name: "이상해꽃", sprite: "/monsters/이상해꽃.png", type: "풀/독", color: "#4fa96b", rarity: 5, catchRate: 0.06, description: "등의 커다란 꽃이 햇빛을 흡수해 에너지로 바꾸며 향기를 퍼뜨린다." },
  { id: "monster-025", name: "리자몽", sprite: "/monsters/리자몽.png", type: "불꽃/비행", color: "#e76f45", rarity: 5, catchRate: 0.06, description: "하늘을 날며 강한 상대를 찾아다니고 뜨거운 불꽃을 내뿜는다." },
  { id: "monster-026", name: "거북왕", sprite: "/monsters/거북왕.png", type: "물", color: "#4f8fc0", rarity: 5, catchRate: 0.06, description: "등껍질의 분사구에서 세차게 물을 뿜어 상대를 압도한다." },
  { id: "monster-027", name: "프리져", sprite: "/monsters/프리져.png", type: "얼음/비행", color: "#70b9dd", rarity: 5, catchRate: 0.015, description: "겨울 하늘에 나타난다고 전해지는 얼음의 전설 포켓몬이다." },
  { id: "monster-028", name: "썬더", sprite: "/monsters/썬더.png", type: "전기/비행", color: "#d9b62e", rarity: 5, catchRate: 0.015, description: "번개와 함께 모습을 드러낸다고 전해지는 전기의 전설 포켓몬이다." },
  { id: "monster-029", name: "파이어", sprite: "/monsters/파이어.png", type: "불꽃/비행", color: "#df7542", rarity: 5, catchRate: 0.015, description: "불타는 날개로 밤하늘을 밝힌다고 전해지는 불꽃의 전설 포켓몬이다." },
  { id: "monster-030", name: "뮤", sprite: "/monsters/뮤.png", type: "에스퍼", color: "#d88fb2", rarity: 5, catchRate: 0.008, description: "모든 포켓몬의 유전자를 가졌다고 전해지는 매우 희귀한 포켓몬이다." },
];
