...
export const MONSTERS: Monster[] = [
  ...
  { id: "monster-027", name: "프리져", sprite: "/monsters/프리져.png", type: "얼음/비행", color: "#70b9dd", rarity: 5, catchRate: 0.015, description: "겨울 하늘의 공기 중에 있는 수분을 얼려 눈을 내리게 만드는 전설의 새 포켓몬." },
  { id: "monster-028", name: "썬더", sprite: "/monsters/썬더.png", type: "전기/비행", color: "#d9b62e", rarity: 5, catchRate: 0.015, description: "하늘이 어두워지고 벼락이 연속으로 떨어진 뒤에야 전설의 포켓몬은 나타난다." },
  { id: "monster-029", name: "파이어", sprite: "/monsters/파이어.png", type: "불꽃/비행", color: "#df7542", rarity: 5, catchRate: 0.015, description: "밤하늘마저 빨갛게 물들일 만큼 세차게 타오르는 날개로 나는 전설의 새 포켓몬." },
  { id: "monster-030", name: "뮤", sprite: "/monsters/뮤.png", type: "에스퍼", color: "#d88fb2", rarity: 5, catchRate: 0.008, description: "현미경으로 관찰하면 매우 짧고 가는 털이 촘촘하게 나 있다." },
];
