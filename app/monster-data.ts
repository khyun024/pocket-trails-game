...
export const MONSTERS: Monster[] = [
  ...
  { id: "monster-020", name: "뮤츠", sprite: "/monsters/뮤츠.png", type: "에스퍼", color: "#8799a1", rarity: 5, catchRate: 0.01, spawnWeight: 0.12, description: "뮤와 유전자가 완전 같다. 하지만 크기도 성격도 무서울 정도로 다르다." },
  ...
  { id: "monster-024", name: "이상해꽃", sprite: "/monsters/이상해꽃.png", type: "풀/독", color: "#4fa96b", rarity: 5, catchRate: 0.06, description: "양분을 흡수해서 커진 봉오리에서 향기가 나기 시작하면 곧 꽃이 핀다는 증거다." },
  { id: "monster-025", name: "리자몽", sprite: "/monsters/리자몽.png", type: "불꽃/비행", color: "#e76f45", rarity: 5, catchRate: 0.06, description: "입에서 작렬하는 불꽃을 토해낼 때 꼬리의 끝이 더욱 붉고 격렬하게 타오른다." },
  { id: "monster-026", name: "거북왕", sprite: "/monsters/거북왕.png", type: "물", color: "#4f8fc0", rarity: 5, catchRate: 0.06, description: "상대를 겨냥한 다음 소방차의 호스보다 강한 기세로 물을 뿜는다." },
  { id: "monster-027", name: "프리져", sprite: "/monsters/프리져.png", type: "얼음/비행", color: "#70b9dd", rarity: 5, catchRate: 0.015, spawnWeight: 0.18, description: "겨울 하늘의 공기 중에 있는 수분을 얼려 눈을 내리게 만드는 전설의 새 포켓몬." },
  { id: "monster-028", name: "썬더", sprite: "/monsters/썬더.png", type: "전기/비행", color: "#d9b62e", rarity: 5, catchRate: 0.015, spawnWeight: 0.18, description: "하늘이 어두워지고 벼락이 연속으로 떨어진 뒤에야 전설의 포켓몬은 나타난다." },
  { id: "monster-029", name: "파이어", sprite: "/monsters/파이어.png", type: "불꽃/비행", color: "#df7542", rarity: 5, catchRate: 0.015, spawnWeight: 0.18, description: "밤하늘마저 빨갛게 물들일 만큼 세차게 타오르는 날개로 나는 전설의 새 포켓몬." },
  { id: "monster-030", name: "뮤", sprite: "/monsters/뮤.png", type: "에스퍼", color: "#d88fb2", rarity: 5, catchRate: 0.008, spawnWeight: 0.08, description: "현미경으로 관찰하면 매우 짧고 가는 털이 촘촘하게 나 있다." },
];
