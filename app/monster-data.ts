...
export const MONSTERS: Monster[] = [
  ...
  { id: "cloudle", name: "구구", sprite: "/monsters/구구.png", type: "비행", color: "#84d8e9", rarity: 4, description: "얌전한 성격이라 습격당해도 반격하지 않고 모래를 뿌려서 몸을 지키는 경우가 많다." },
  ...
  { id: "monster-009", name: "이상해풀", sprite: "/monsters/이상해풀.png", type: "풀", color: "#6fbd67", rarity: 5, description: "양분을 흡수해서 커진 봉오리에서 향기가 나기 시작하면 곧 꽃이 핀다는 증거다." },
